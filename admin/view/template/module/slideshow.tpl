          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              ...
              <td class="left"><select name="slideshow_module[<?php echo $module_row; ?>][position]">
                  ...
                  <?php } ?>
                  <?php if ($module['position'] == 'header_slideshow') { ?>
                  <option value="header_slideshow" selected="selected"><?php echo $text_header_slideshow; ?></option>
                  <?php } else { ?>
                  <option value="header_slideshow"><?php echo $text_header_slideshow; ?></option>
                   <?php } ?>
                </select></td>
...
function addModule() {	
  ...
  html += '      <option value="header_slideshow"><?php echo $text_header_slideshow; ?></option>';
	html += '    </select></td>';
