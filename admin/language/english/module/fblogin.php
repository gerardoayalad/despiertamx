...
$_['entry_fbfriend_status'] = 'Enable Facebook friend module:<br /><span class="help">Customers friend list will be dispalyed on products info page who purchased those product.</span>';
$_['entry_apikey']          = 'Facebook API Key:';
$_['entry_apisecret']       = 'Facebook API Secret:';
$_['entry_pwdsecret']       = 'Password Encryption Key:<span class="help">To make the customer password more safe, 4 to 8 characters (eg. w7x4 ).</span>';
